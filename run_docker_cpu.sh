...
#docker run -it -p 8000:8000 -e READER_MODEL_PATH=mrm8488/bert-base-spanish-wwm-cased-finetuned-spa-squad2-es --entrypoint bash haystack_cpu

docker run --net=host -e READER_MODEL_PATH=mrm8488/bert-base-spanish-wwm-cased-finetuned-spa-squad2-es -d deepset/haystack-cpu:latest